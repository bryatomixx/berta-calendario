...
import { fechaLarga, fechaCorta } from "@/components/FechaDisplay";
import { obtenerCliente, cargarCalendario } from "@/lib/clientes";
...
export default async function ClienteDetalle({
  ...
  return (
    <Shell>
      <div className="px-8 md:px-16 lg:px-20 py-12 max-w-5xl">
        {/* Breadcrumb */}
        <Link
          href="/clientes"
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-px rounded-xl bg-rule overflow-hidden paper-shadow mb-12">
          <DataCard label="Régimen IVA" value={REGIMEN_LABEL[cliente.regimenIva]} />
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm text-ink-muted mt-0.5">
                              ...
                              <span className="text-ink-faint"> · período </span>
                              <span>{v.periodo}</span>
                            </p>
                          </div>
                          <SemaforoBadge
