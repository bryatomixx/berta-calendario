...
function t(
  ...
  return {
    id, title, description, category, status, priority, member_id, hours,
...
const tasks: Task[] = [
  t('t1', 'Conciliación bancaria de mayo', 'Contabilidad', 'hecho', 'alta', 'w1', 4, '2026-06-04', 0, 'pr1'),
  t('t2', 'Declaración de IVA mensual', 'Impuestos', 'hecho', 'alta', 'w2', 3, '2026-06-09', 1, 'pr2'),
  t('t3', 'Cálculo de nómina quincenal', 'Nómina', 'en_proceso', 'alta', 'w3', null, '2026-06-18', 2, 'pr1'),
  t('t4', 'Emitir facturas pendientes del mes', 'Facturación', 'pendiente', 'media', 'w1', null, '2026-06-21', 3, null),
  t('t5', 'Trámite de alta patronal', 'Trámites', 'hecho', 'media', 'w4', 2, '2026-06-02', 4, null),
  t('t6', 'Revisión de gastos deducibles', 'Contabilidad', 'hecho', 'media', 'w2', 5, '2026-06-11', 5, 'pr1'),
  t('t7', 'Auditoría interna del segundo trimestre', 'Auditoría', 'en_proceso', 'baja', 'w3', null, '2026-06-17', 6, 'pr3'),
  t('t8', 'Reunión mensual de equipo', 'Reunión', 'pendiente', 'media', 'w4', null, '2026-06-24', 7, 'pr4'),
  t('t9', 'Digitalizar expedientes 2024', 'Trámites', 'hecho', 'baja', 'w4', 6, '2026-06-05', 8, 'pr3'),
  t('t10', 'Preparar declaración anual', 'Impuestos', 'en_proceso', 'alta', 'w1', null, '2026-06-19', 9, 'pr2'),
  t('t11', 'Capacitación en software contable', 'Reunión', 'pendiente', 'media', 'w2', null, '2026-06-22', 10, 'pr4'),
  t('t12', 'Conciliación de cuentas por cobrar', 'Contabilidad', 'pendiente', 'media', 'w3', null, '2026-06-20', 11, null),
];
